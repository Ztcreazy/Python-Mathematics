...
logging.basicConfig(
    level=logging.DEBUG, filename="MPC/VehicleSteering/steering-integral_cost.log",
...
logging.basicConfig(
    level=logging.INFO, filename="MPC/VehicleSteering/steering-terminal_cost.log",
    filemode='w', force=True)
...
logging.basicConfig(
    level=logging.DEBUG, filename="MPC/VehicleSteering/steering-terminal_constraint.log",
    filemode='w', force=True)
