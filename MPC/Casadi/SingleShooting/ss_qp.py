...
if __name__ == '__main__':
    ...
    # To solve this problem with the high-level interface, 
    # we simply replace nlpsol with qpsol and use a QP solver plugin 
    # such as the with CasADi distributed qpOASES:
    ...
    print("(time - start) / mpciter: ", (time.time() - start_time)/(mpciter))
