...
class NMPC:
    ...
    def plot_graphs(self,t_past,t_pasts,Xd_pasts,Xa_pasts,U_pasts,Xd_pastse,Con_pasts):
        ...
        for j in range(nd):
            ...
            plt.title('Monte Carlo trajectories of ' + states[j])
            plt.grid(True)
            plt.show()
        ...
        for j in range(na):
            ...
            plt.xlabel('time')
            plt.xlim([0,simulation_time])
            plt.title('Monte Carlo trajectories of ' + algebraics[j])
        ...
        for k in range(nu):
            ...
            plt.xlabel('time')
            plt.xlim([0,simulation_time])
            plt.title('Monte Carlo trajectories of ' + inputs[k])
            plt.grid(True)
            plt.show()
        ...
        for j in range(nd):
            ...
            plt.xlabel('time')
            plt.xlim([0,simulation_time])
            plt.title('Monte Carlo trajectories of ' + states[j] + " state estimate")
            plt.grid(True)
            plt.show()
        ...
        for j in range(nd):
            ...
            plt.xlabel('time')
            plt.xlim([0,simulation_time])
            plt.title('Trajectory of ' + states[j] + ' for last Monte Carlo run')
            plt.legend()
            plt.grid(True)
            plt.show()
        ...
        for j in range(na):
            ...
            plt.xlabel('time')
            plt.xlim([0,simulation_time])
            plt.title('Trajectory of ' + algebraics[j] + ' for last Monte Carlo run')
        ...
        for k in range(nu):
            ...
            plt.xlabel('time')
            plt.xlim([0,simulation_time])  
            plt.title('Trajectory of ' + inputs[k] + ' for last Monte Carlo run')
            plt.grid(True)
            plt.show()
        ...
        for j in range(ng):
            ...
            plt.xlabel('time')
            plt.xlim([0,t_pasts[-1]])
            plt.title('Trajectory of g' + str(j) + ' for last Monte Carlo run')
            plt.grid(True)
            plt.show()
        ...
        savemat('MPC/NMPC/Data_NMPC',Data_NMPC)    
    ...
    def save_varsopthyp(self,varsopt):
        try:
            with open("MPC/NMPC/varspopt" + ".pkl", 'wb') as a_file:
